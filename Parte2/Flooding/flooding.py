...
class Flooding(slixmpp.ClientXMPP):
    ...
    async def flood_send(self):
        print("Ingrese el usuario al que desea enviar el mensaje (sin @alumchat.xyz): ")
        ...
        try:
            print(
                "Getting key: ",
                list(self.json_data["config"].keys())[
                    list(self.json_data["config"].values()).index(self.jid)
                ],
            )
            node = list(self.json_data["config"].keys())[
                list(self.json_data["config"].values()).index(self.jid)
            ]
    ...
    def message(self, msg):
        ...
        if msg["type"] in ("chat", "normal"):
            msg_f = eval(msg["body"])
            node = list(self.json_data["config"].keys())[
                list(self.json_data["config"].values()).index(msg_f["source"])
            ]
